			...
			<div class="col-md-8 col-md-offset-2">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title"><?php echo lang('display_delete'); ?></h3>
					</div>
					<div class="box-body">
						<?php echo form_open(current_url(), array('class' => 'form-horizontal', 'id' => 'form-delete_display')); ?>
							<div class="form-group">
								<div class="col-sm-10 col-sm-offset-1">
									<div class="alert alert-warning">
										<?php echo sprintf(lang('display_delete_confirm'), html_escape($setting['nama_client'])); ?>
									</div>
								</div>
							</div>
							<div class="form-group">
