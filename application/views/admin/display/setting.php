			...
			<div class="col-md-10 col-md-offset-1">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title"><?php echo lang('display_title'); ?></h3>
					</div>
					<div class="box-body">
						<?php echo $message; ?>

						<?php echo form_open(current_url(), array('class' => 'form-horizontal', 'id' => 'form-display-setting')); ?>
								...
								<div class="col-sm-9">
									<select class="form-control" id="id_client" name="id_client">
										<?php if ( ! empty($clients)): ?>
											...
											<?php endforeach; ?>
										<?php else: ?>
											<option value="0"><?php echo lang('display_no_client'); ?></option>
										<?php endif; ?>
									</select>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<?php
									$palette = array('#4e73df', '#1e88e5', '#008000', '#808080', '#800080', '#ff0000', '#ff9900');
									?>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-9">
									<?php echo form_button(array('type' => 'submit', 'name' => 'submit_display', 'value' => '1', 'class' => 'btn btn-primary btn-flat', 'content' => lang('actions_submit'))); ?>
								</div>
							</div>
						<?php echo form_close(); ?>
					</div>
	...
	(function() {
		...
		if (clientSelect) {
			clientSelect.addEventListener('change', function() {
				...
				window.location.href = base + '?id_client=' + encodeURIComponent(clientSelect.value);
			});
		}
		if (fontSize && output) {
