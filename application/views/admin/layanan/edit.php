						...
						<div class="col-md-8 col-md-offset-2">
							 <div class="box">
								<div class="box-header with-border">
									<h3 class="box-title"><?php echo lang('layanan_edit'); ?> &mdash; <span class="label label-primary"><?php echo htmlspecialchars($layanan['kode_huruf'], ENT_QUOTES, 'UTF-8'); ?></span></h3>
								</div>
								<div class="box-body">
									<?php echo $message; ?>

									<?php echo form_open(current_url(), array('class' => 'form-horizontal', 'id' => 'form-edit_layanan')); ?>
										<div class="form-group">
											<?php echo lang('layanan_kode_huruf', 'kode_huruf', array('class' => 'col-sm-3 control-label')); ?>
											<div class="col-sm-9">
												<?php echo form_input($kode_huruf); ?>
												<p class="help-block">Contoh: A, B, CS (maks 5 karakter)</p>
											</div>
										</div>
										<div class="form-group">
