                        ...
                        <div class="col-md-12">
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo sprintf(lang('users_deactivate_question'), '<span class="label label-primary">'.htmlspecialchars($firstname.$lastname, ENT_QUOTES, 'UTF-8').'</span>');?></h3>
                                </div>
                                <div class="box-body">
